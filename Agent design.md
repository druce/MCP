...
proof of concept deep research agent to analyze a stock. Standard format, 8 sections:
1. Profile
...
8. Overall Assessment:
	• Summarize the company’s strategic position, risks, opportunities, and any “watch points” for further diligence.
...
2. user enters a stock, 
	...
	2. show the standard deep research output outline, ask the user if any other specific questions. outline is 7 sections , with an initial prompt for each section on what info to search for and continue
...
5. evergreen tasks, always put into queue , all sections dependent on them
